...
namespace Consoletest001.Sqlite
{
    ...
    public class SQLiteHelper
    {
        ...
        {
            System.Data.SQLite.SQLiteConnectionStringBuilder conbuilder = new SQLiteConnectionStringBuilder();
            conbuilder.DataSource = "E:\\test.db";
        }
        /// <summary>
        /// Creates the command.
        /// </summary>
        ...
        /// <returns></returns>
        public static DataSet ExecuteDataSet(SQLiteConnection cn, string commandText, params object[] paramList)
        {
