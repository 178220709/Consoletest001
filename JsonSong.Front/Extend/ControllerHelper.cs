...
namespace JsonSong.Front.Extend
{
    public  static  class ControllerHelper
    {
        public static IEnumerable<ModuleDTO> GetIndexModules( )
        {
            ...
            var typeArr = assembly.GetTypes().Where(a => a.FullName.StartsWith("JsonSong.Front.Controllers")).ToList()
        ...
        private static bool HasAttribute<T>(this MemberInfo type) where T : Attribute
        {
            var attributes = type.GetCustomAttributes(typeof(T), false);
