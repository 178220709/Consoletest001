...
namespace Geoway.Archiver.ReceiveAndRetrieve.DAL
{
    ...
    public class CoreMetaDateInfoSpatialDAL : CoreDataInfo,ICoreMetaDateInfoDAL
    {
        
        //public static CoreMetaDateInfoSpatialDAL Singleton=new CoreMetaDateInfoSpatialDAL();

        public CoreMetaDateInfoSpatialDAL(string tableName, long dataID)
            : base(tableName, dataID)
        {
        }

        #region IDBOper<CoreMetaDateInfoDAL> 成员
