...
var _c8=_c6.tree;
_c6.disabledNodes=[];
_c8.find("div.tree-node")._draggable({disabled:false,revert:true,cursor:"pointer",proxy:function(_c9){
...
var _db=$(_d9)._draggable("proxy").find("span.tree-dnd-icon");
...
_23b.window._draggable({handle:">div.panel-header>div.panel-title",disabled:_23b.options._draggable==false,onStartDrag:function(e){
if(_23b.mask){
...
_23b.window._resizable({disabled:_23b.options._resizable==false,onStartResize:function(e){
...
return $.extend({},$.fn.panel.parseOptions(_244),$.parser.parseOptions(_244,[{_draggable:"boolean",_resizable:"boolean",shadow:"boolean",modal:"boolean",inline:"boolean"}]));
};
...
win.window({title:_265,noheader:(_265?false:true),width:300,height:"auto",modal:true,collapsible:false,minimizable:false,maximizable:false,_resizable:false,onClose:function(){
setTimeout(function(){
win.window("destroy");
},100);
}});
...
_348._resizable($.extend({},{handles:_349,onStartResize:function(e){
_32e=true;
...
_505.each(function(){
$(this)._resizable({handles:_50d,disabled:($(this).attr("_resizable")?$(this).attr("_resizable")=="false":false),minWidth:25,onStartResize:function(e){
_502.resizing=true;
...
$.fn.propertygrid.defaults=$.extend({},$.fn.datagrid.defaults,{singleSelect:true,remoteSort:false,fitColumns:true,loadMsg:"",frozenColumns:[[{field:"f",width:16,_resizable:false}]],columns:[[{field:"name",title:"Name",width:100,sortable:true},{field:"value",title:"Value",width:100,_resizable:false}]],showGroup:false,groupField:"group",groupFormatter:function(_6ec,rows){
return _6ec;
}});
})(jQuery);
(function($){
...
_8e0.find("a.slider-handle")._draggable({axis:opts.mode,cursor:"pointer",disabled:opts.disabled,onDrag:function(e){
