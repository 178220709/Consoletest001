...
namespace Suijing.Utils.WebTools
{
    ...
    public class DataCache
    {
        ...
        public static string webconfigfile
        {
            get
            {
                if (string.IsNullOrEmpty(_webconfigfile))
                    _webconfigfile = HttpContext.Current.Server.MapPath("/web.config");
        ...
        public static string shopconfigfile
        {
            get
            {
                if (string.IsNullOrEmpty(_shopconfigfile))
                    _shopconfigfile = HttpContext.Current.Server.MapPath("/App_Data/ShopConfig.config");
        ...
        public static string siteconfigfile
        {
            get
            {
                if (string.IsNullOrEmpty(_siteconfigfile))
                    _siteconfigfile = HttpContext.Current.Server.MapPath("/App_Data/SiteConfig.config");
        ...
        public static string templateconfigfile
        {
            get
            {
                if (string.IsNullOrEmpty(_templateconfigfile))
                    _templateconfigfile = HttpContext.Current.Server.MapPath("/App_Data/Template.config");
        ...
        public static void SetCacheSecond(string CacheKey, object objObject, int seconds, TimeSpan slidingExpiration = default(TimeSpan))
        {
